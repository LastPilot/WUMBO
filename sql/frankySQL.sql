...
insert into persons values(1, 'Pamula', 'godmula', 'godmula@calstatela.edu', 100100100, 'a', true);
insert into persons values(2, 'Franky Gudino', 'fgudino3', 'frankyjg96@gmail.com', 300300300, 'a', false);
insert into persons values(3, 'firstname lastname','a', 'a', 200200200, 'a', false);
-- enter your own student values here, choose a cin, then set its last value to true below


-- sample cins
insert into cins values(100100100, 'addyouremail', 10.0, true);
insert into cins values(200200200, 'addyouremail', 2.0, true);
